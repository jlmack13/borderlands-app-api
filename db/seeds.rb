...
Loot.create(name: 'Chain Lightning', item_type: 'Grenade Mod', manufacturer: 'Maliwan', drop: 'Badass Sorcerer', location: "Hatred's Shadow, Lair of Infinite Agony, Dragon Keep", image_url: 'https://vignette.wikia.nocookie.net/borderlands/images/a/a1/Chain_lightning.png/revision/latest?cb=20130626161122');
...
Loot.create(name: 'Firestorm', item_type: 'Grenade Mod', manufacturer: 'Maliwan', drop: 'Badass Sorcerer', location: "Hatred's Shadow, Lair of Inifinite Agony, Dragon Keep", image_url: 'https://vignette.wikia.nocookie.net/borderlands/images/6/60/Fire_storm.png/revision/latest?cb=20130626161352');
...
Loot.create(name: 'Bonus Package', item_type: 'Grenade Mod', manufacturer: 'Torgue', drop: 'Boom and Bewm', location: 'Southern Shelf', story_mode: true, story_id: 2, story_quest: 'Best Minion Ever', image_url: 'https://vignette.wikia.nocookie.net/borderlands/images/2/24/Sticky_Homing_Bonus_P.jpg/revision/latest?cb=20121222185646');
